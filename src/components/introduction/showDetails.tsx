    ...
    return(
        <div className="mt-[min(15vw,80px)]  md:mt-[13vw]  lg:mt-[min(15vw,80px)] bg-white min-h-screen">
            ...
            <div className="max-w-[1100px] lg:mx-auto pb-[20vw] lg:pb-[5vw] bg-white lg:px-4 lg:shadow-md ">
                ...
                <div className="flex">
                    <Link href={{pathname:"/viewer/edit",query:{name:name}}}  className="m-auto w-30 h-auto text-center py-2 border-none rounded-sm shadow-md bg-amber-50 hover:scale-105 transition duration-300 ">編集</Link>
                </div>
