    ...
    return(
        <header className="w-full h-[15vw] relative max-h-20 md:max-h-[13vw] lg:max-h-20">
            ...
            <div className="w-full h-full flex items-center justify-between">
                ...
                <div ref={targetMenu} className={`overflow-hidden w-full h-0  bg-gradient-to-br opacity-[0.92]  from-[#05a8bd] via-[#05bd92] to-[#f3e50a] absolute top-0 left-0 z-[50] `}>    
